                ...
                <div className="copybook-container">
                  <div className="copybook">
                    ...
                    <div className="copybook-content">
                      <h2 className="text-2xl font-bold text-green-700 mb-4 bubbly-font">Téamaí</h2>
              ...
              <Link href="/literature" className="block">
                <div className="copybook-container">
                  <div className="copybook">
                    <div className="spiral"></div>
                    <div className="copybook-content">
                      <h2 className="text-2xl font-bold text-green-700 mb-4 bubbly-font">Litríocht</h2>
                      <p className="text-center text-muted-foreground mb-6 bubbly-font">
              ...
              <Link href="/exam-practice" className="block">
                <div className="copybook-container">
                  <div className="copybook">
                    <div className="spiral"></div>
                    <div className="copybook-content">
                      <h2 className="text-2xl font-bold text-green-700 mb-4 bubbly-font">Ag ullmhú don scrúdú</h2>
                      <p className="text-center text-muted-foreground mb-6 bubbly-font">
              ...
              <Link href="/about" className="block">
                <div className="copybook-container">
                  <div className="copybook">
                    <div className="spiral"></div>
                    <div className="copybook-content">
                      <h2 className="text-2xl font-bold text-green-700 mb-4 bubbly-font">Fúinn</h2>
