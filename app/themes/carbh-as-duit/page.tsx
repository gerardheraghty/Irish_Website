      ...
      <main className="flex-1">
        <div className="container px-4 md:px-6 py-12 max-w-5xl mx-auto">
            ...
            <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-md border border-green-100">
              <ol className="text-lg space-y-3 text-left">
                <li className="flex items-start">
                  ...
                  <span>Foclóir ginearálta a bhaineann le haonad 1.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-bold text-green-700 mr-2">2.</span>
                  <span>Gramadach: Ord na n-abairtí, an réamhfhocal 'ar' agus an aidiacht shealbhach.</span>
                </li>
                <li className="flex items-start">
                  <span className="font-bold text-green-700 mr-2">3.</span>
                  <span>Éist le comhrá: Ceachtanna i bhfíorchomhthéacs.</span>
                </li>
                <li className="flex items-start">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Link href="/themes/carbh-as-duit/section-1" className="block group">
              <div className="p-8 bg-white rounded-xl shadow-md border border-green-100 hover:shadow-xl transition-all duration-200 h-full group-hover:border-green-300 group-hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-green-700">Foclóir ginearálta</h2>
                </div>
            ...
            <Link href="/themes/carbh-as-duit/section-2-a" className="block group">
              <div className="p-8 bg-white rounded-xl shadow-md border border-green-100 hover:shadow-xl transition-all duration-200 h-full group-hover:border-green-300 group-hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 rounded-full bg-green-100 text-green-700 flex items-center justify-center font-bold text-lg mr-3">
                    <Pencil className="h-5 w-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-green-700">Gramadach</h2>
                </div>
            ...
            <Link href="/themes/carbh-as-duit/section-3" className="block group">
              <div className="p-8 bg-white rounded-xl shadow-md border border-green-100 hover:shadow-xl transition-all duration-200 h-full group-hover:border-green-300 group-hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 rounded-full bg-green-100 text-green-700 flex items-center justify-center font-bold text-lg mr-3">
                    <Headphones className="h-5 w-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-green-700">Éist le comhrá</h2>
                </div>
            ...
            <Link href="/themes/carbh-as-duit/section-4" className="block group">
              <div className="p-8 bg-white rounded-xl shadow-md border border-green-100 hover:shadow-xl transition-all duration-200 h-full group-hover:border-green-300 group-hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 rounded-full bg-green-100 text-green-700 flex items-center justify-center font-bold text-lg mr-3">
                    <GraduationCap className="h-5 w-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-green-700">Ceachtanna aonaracha agus punainne</h2>
                </div>
